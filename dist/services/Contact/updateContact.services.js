...
const updateContactServices = (payload, contactId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updateContact = Object.assign(Object.assign({}, contact), payload);
    yield contactRepository.save(updateContact);
    return contacts_schemas_1.contactSchema.parse(updateContact);
});
